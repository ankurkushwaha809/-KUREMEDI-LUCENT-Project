...
function mapCartItem(item: {
  product?: { _id: string; productName?: string; sellingPrice?: number; finalSellingPrice?: number; productImages?: string[]; minOrderQty?: number };
  quantity?: number;
}): CartItem | null {
  ...
  const refreshCart = useCallback(async () => {
    ...
    try {
      const res = (await getCart()) as {
        items?: { product?: { _id: string; productName?: string; sellingPrice?: number; finalSellingPrice?: number; productImages?: string[] }; quantity?: number }[];
      };
